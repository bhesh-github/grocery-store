...
const MyOrders = ({
  ...
  const [activeMyOrdersSettingMenu, setActiveMyOrdersSettingMenu] = useState(0);
  ...
  const handleMenuClick = (item) => {
    item === "To Pay" && setCurrentMenu("To Pay");
    item === "Paid" && setCurrentMenu("Paid");
    item === "To Receive" && setCurrentMenu("To Receive");
    item === "All" && setCurrentMenu("All");
  };
      ...
      <div className="my-orders-page">
        ...
        <div className="nav-menu-wrapper">
          <div className="nav-menu">
            {myOrdersSettingMenu &&
              myOrdersSettingMenu.map((item = "", idx = "") => {
                return activeMyOrdersSettingMenu === idx ? (
                  <span
                  ...
                  <span
                    ...
                    onClick={() => {
                      ...
                      setActiveMyOrdersSettingMenu(idx);
                    }}
                  >
                    {item}
                  </span>
